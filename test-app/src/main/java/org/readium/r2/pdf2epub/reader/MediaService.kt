...
class MediaService : MediaSessionService() {
    ...
    inner class Binder : android.os.Binder() {
        ...
        private val app: org.readium.r2.pdf2epub.Application
            get() = application as org.readium.r2.pdf2epub.Application
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val readerRepository = (application as org.readium.r2.pdf2epub.Application).readerRepository
    ...
    companion object {
        ...
        const val SERVICE_INTERFACE = "org.readium.r2.pdf2epub.reader.MediaService"

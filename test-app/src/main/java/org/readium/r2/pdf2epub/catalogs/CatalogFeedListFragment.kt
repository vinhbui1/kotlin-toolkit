...
import org.readium.r2.pdf2epub.databinding.FragmentCatalogFeedListBinding
...
class CatalogFeedListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val preferences =
            requireContext().getSharedPreferences("org.readium.r2.pdf2epub", Context.MODE_PRIVATE)
